...
public class Message implements Serializable {
    ...
    private HashMap<String, Socket> theClientMap;//同步给客户端用的
     ...
     * @return 服务器的用户列表
     */
    public HashMap<String, Socket> getTheClientMap() {
        return theClientMap;
    }
     ...
     */
    public void syncSend(String theMessage, HashMap<String, Socket> theClientMap, int theClientCount) {
        this.theType = 2;
        this.theMessage = theMessage;
